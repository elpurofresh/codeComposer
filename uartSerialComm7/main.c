...
void main(void)
{
	...
	while(1){
		...
		case 0:
			sendEscapeCmd();
			task = 9;			// Avoid keep getting in this case statement by usiny a number different from any task
			break;
...
void setupUART(void)
{
	...
	P1DIR = 0xFF & ~UART_RXD;                 // All P1.x outputs except UART receiving pin
	P1IN |= UART_RXD;
