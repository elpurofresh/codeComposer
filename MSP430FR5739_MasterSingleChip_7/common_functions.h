...
void genPacket(void)
{
	...
	itoa(myBotID, temp1);
	buffToNetwork[0] = temp1[0];

	itoa(myParent, temp1);
	buffToNetwork[1] = temp1[0];

	itoa(myHasChild, temp1);
	buffToNetwork[2] = temp1[0];

	itoa(myHasSeenLeaf, temp1);
	buffToNetwork[3] = temp1[0];

	itoa(mySndFstTime, temp1);
	buffToNetwork[4] = temp1[0];

	itoa(myTimeSlotCounter,temp1);
	buffToNetwork[5] = temp1[0];

	itoa(hrs, temp2);
	buffToNetwork[6] = temp2[0];
	buffToNetwork[7] = temp2[1];
	temp2[0] = '0'; temp2[1] = '0';

	itoa(min, temp2);
	buffToNetwork[8] = temp2[0];
	buffToNetwork[9] = temp2[1];
	temp2[0] = '0';	temp2[1] = '0';

	itoa(sec, temp2);
	buffToNetwork[10] = temp2[0];
	buffToNetwork[11] = temp2[1];

	itoa(numBotsData, temp1);
	buffToNetwork[12] = temp1[0];

	itoa(myBotID, temp1);
	buffToNetwork[13] = temp1[0];

	itoa(hrs, temp2);
	buffToNetwork[14] = temp2[0];
	buffToNetwork[15] = temp2[1];
	temp2[0] = '0';	temp2[1] = '0';

	itoa(min, temp2);
	buffToNetwork[16] = temp2[0];
	buffToNetwork[17] = temp2[1];
	temp2[0] = '0';	temp2[1] = '0';

	itoa(sec, temp2);
	buffToNetwork[18] = temp2[0];
	buffToNetwork[19] = temp2[1];
	temp2[0] = '0';	temp2[1] = '0';

	itoa(OX, temp2);
	buffToNetwork[20] = temp2[0];
	buffToNetwork[21] = temp2[1];

	itoa(PH, temp2);
	buffToNetwork[22] = temp2[0];
	buffToNetwork[23] = temp2[1];

	itoa(TP, temp2);
	buffToNetwork[24] = temp2[0];
	buffToNetwork[25] = temp2[1];

	itoa(AB, temp2);
	buffToNetwork[26] = temp2[0];
	buffToNetwork[27] = temp2[1];
}
...
void putBotMyChildrenList(char botToInsert)
{
	...
	while(myChildrenList[i] != INDEFINED){
