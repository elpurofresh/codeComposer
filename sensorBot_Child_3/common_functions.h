...
void initUARTSdCard(void)
{
	...
	UCA1BR1 = 0;
	//UCA1MCTLW |= UCOS16;						// OS16 enabled because we are using SMCLK @ 8MHz High Freq.
	//UCA1MCTLW |= 0x01;						// 52.083-52 = 0.083 *16 = 1.33
	//UCA1MCTLW |= 0x49;                      	// UCBRSx value 0.3335= 0x42 (See UG)
